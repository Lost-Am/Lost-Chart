...
function onEvent(n,v1,v2)
      ...
      elseif n == 'Change Character' then
		...
		if getProperty('ov.alpha') > 0 then
			...
			if v1 == 'bf' then
        			runHaxeCode([[
    					FlxTween.tween(game.bf.colorTransform, { redOffset: ]]..rgbbf[1]..[[, greenOffset: ]]..rgbbf[2]..[[, blueOffset: ]]..rgbbf[3]..[[, redMultiplier: 0, greenMultiplier: 0, blueMultiplier: 0 }, 0.01);
    				]])
			end
		else
			if v1 == 'dad' then
